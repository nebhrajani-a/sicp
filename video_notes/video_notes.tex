...
\label{sec:orge9d49ba}

\section{About}
\label{sec:org7be1580}
...
\label{sec:orgb40cb67}

\section{Substitution Rule/Model}
\label{sec:org141de53}
...
\label{sec:org97ae75c}

\subsection{Simple Peano Addition}
\label{sec:org75d8f8c}
...
\label{sec:org06f2fc7}

\section{Abstracting Procedural Ideas}
\label{sec:org4da7b2d}
...
\label{sec:orgc8787f1}

\begin{enumerate}
\item Rectangles
\label{sec:org43f0052}
...
\label{sec:org93a819d}

\subsection{Using Lisp Syntax}
\label{sec:org1d769d0}
...
may need to match, according to the rule language (\ref{sec:orgf3d81a1}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:orgf3d81a1}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:org2a6f6dc}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:org6991484}
...
Excellent. We now have a complete pattern matching and replacement
language at our disposal, and we've tested it out on the rules of
