...
\label{sec:org4dbeacd}

\section{About}
\label{sec:org6f8d912}
...
\label{sec:org76ab3a7}

\section{Substitution Rule/Model}
\label{sec:orgfc442d9}
...
\label{sec:orgf444c1a}

\subsection{Simple Peano Addition}
\label{sec:org487f6d9}
...
\label{sec:org0d2cdd5}

\section{Abstracting Procedural Ideas}
\label{sec:org3b4c620}
...
\label{sec:orgee89187}

\begin{enumerate}
\item Rectangles
\label{sec:orged57f38}
...
\label{sec:org8d616fd}

\subsection{Using Lisp Syntax}
\label{sec:org95fb414}
...
may need to match, according to the rule language (\ref{sec:org73b1a09}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:org73b1a09}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:orga1efba7}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:org9706ae3}
