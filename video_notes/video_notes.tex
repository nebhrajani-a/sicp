...
\label{sec:orgf3af81f}

\section{Substitution Rule/Model}
\label{sec:org30ea388}
...
\label{sec:org46db812}

\subsection{Simple Peano Addition}
\label{sec:orgf922a33}
...
\label{sec:org48b2232}

\section{Abstracting Procedural Ideas}
\label{sec:org978ced4}
...
\label{sec:org0a0c5cd}

\begin{enumerate}
\item Frames
\label{sec:org8a482c5}
...
\label{sec:orgd344847}

\subsection{Using Lisp Syntax}
\label{sec:orgce4ba4a}
...
may need to match, according to the rule language (\ref{sec:orgbc54f2e}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:orgbc54f2e}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:orgbe63dcc}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:org3c77fba}
...
\label{sec:org0d3163a}

\subsection{On Complex Numbers}
\label{sec:org8686296}
...
\label{sec:org0a04f88}

\subsection{Architecture}
\label{sec:org3a22683}
...
\label{sec:orgbde0c0d}

\subsection{Functional Programming}
\label{sec:orgda9043f}
