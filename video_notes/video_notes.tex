...
\label{sec:orgb54f26f}

\section{Substitution Rule/Model}
\label{sec:orgc10413a}
...
\label{sec:org955d7f7}

\subsection{Simple Peano Addition}
\label{sec:org7bd1048}
...
\label{sec:org01aa236}

\section{Abstracting Procedural Ideas}
\label{sec:org9a2c1b5}
...
\label{sec:org0018899}

\begin{enumerate}
\item Frames
\label{sec:org932da17}
...
\label{sec:org481ff17}

\subsection{Using Lisp Syntax}
\label{sec:orgd6fafb1}
...
may need to match, according to the rule language (\ref{sec:org40af964}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:org40af964}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:org86d820c}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:orgb754320}
...
\label{sec:org249b9d2}

\subsection{On Complex Numbers}
\label{sec:orgcc509ea}
...
\label{sec:orgc74e7da}

\subsection{Architecture}
\label{sec:org4e67b95}
...
\label{sec:org62f45f1}

\subsection{Functional Programming}
\label{sec:org0a6ff1b}
