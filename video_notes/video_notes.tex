...
\chapter{Prologue}
\label{sec:org2b1716c}
\section{About}
\label{sec:org311cf0a}
...
\label{sec:orgabd1409}

\section{Substitution Rule/Model}
\label{sec:orga1f094f}
...
\label{sec:org0adb76a}

\subsection{Simple Peano Addition}
\label{sec:org93d87a8}
...
\label{sec:org1539afc}

\section{Abstracting Procedural Ideas}
\label{sec:org8d47374}
...
\label{sec:org216c761}

\begin{enumerate}
\item Frames
\label{sec:org31dccbd}
...
\label{sec:orgc2ac5a3}

\subsection{Using Lisp Syntax}
\label{sec:org910e722}
...
may need to match, according to the rule language (\ref{sec:orgc93ecfe}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:orgc93ecfe}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:orgde65bf8}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:org0da4265}
...
\label{sec:org544ad48}

\subsection{On Complex Numbers}
\label{sec:org5c7af89}
...
\label{sec:orgd8d6bdf}

\subsection{Architecture}
\label{sec:org652180b}
...
\label{sec:org7a2cb10}

\subsection{Functional Programming}
\label{sec:org2f72e42}
