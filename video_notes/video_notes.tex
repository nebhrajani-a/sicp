...
\chapter{Prologue}
\label{sec:org912a3b7}
\section{About}
\label{sec:org4f5e20c}
...
\label{sec:orgf29bf9b}

\section{Substitution Rule/Model}
\label{sec:org4e8bf42}
...
\label{sec:org104f7e2}

\subsection{Simple Peano Addition}
\label{sec:org55f5b07}
...
\label{sec:orga9cb9ce}

\section{Abstracting Procedural Ideas}
\label{sec:org9c8b8af}
...
\label{sec:org85331a0}

\begin{enumerate}
\item Frames
\label{sec:orge9b7734}
...
\label{sec:org7106f1f}

\subsection{Using Lisp Syntax}
\label{sec:orgc8b9325}
...
may need to match, according to the rule language (\ref{sec:org8926f79}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:org8926f79}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:org190f65d}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:org0735521}
...
\label{sec:org0300858}

\subsection{On Complex Numbers}
\label{sec:org053c2ee}
...
\label{sec:orgdb62738}

\subsection{Architecture}
\label{sec:org999f45c}
...
\label{sec:org2f4e71d}

\subsection{Functional Programming}
\label{sec:org629ccb1}
...
\label{sec:orgb458c25}

\subsection{Flattening}
\label{sec:org5bfd56f}
...
\label{sec:org7179fe7}


\section{The Catch: On Efficiency}
\label{sec:org5f9591f}
