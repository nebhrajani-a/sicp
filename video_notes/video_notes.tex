...
\label{sec:orgb46e264}

\section{About}
\label{sec:orgf71a44f}
...
\label{sec:org99b8ceb}

\section{Substitution Rule/Model}
\label{sec:orgdbef4fb}
...
\label{sec:org8ad7280}

\subsection{Simple Peano Addition}
\label{sec:org51a83ef}
...
\label{sec:orgd7bead1}

\section{Abstracting Procedural Ideas}
\label{sec:orgb97893d}
...
\label{sec:orgc5d5d68}

\begin{enumerate}
\item Rectangles
\label{sec:org944bba3}
...
\label{sec:orgf3a6fc1}

\subsection{Using Lisp Syntax}
\label{sec:org15d5492}
