...
\label{sec:orgb35b716}

\section{Substitution Rule/Model}
\label{sec:org78c9208}
...
\label{sec:org3ac91e7}

\subsection{Simple Peano Addition}
\label{sec:org27871f0}
...
\label{sec:org87bd9d6}

\section{Abstracting Procedural Ideas}
\label{sec:orgbee5665}
...
\label{sec:org6852cf0}

\begin{enumerate}
\item Frames
\label{sec:org011aa3f}
...
\label{sec:orgc1f28be}

\subsection{Using Lisp Syntax}
\label{sec:orgb8b15eb}
...
may need to match, according to the rule language (\ref{sec:org1a46242}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:org1a46242}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:org0364d3c}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:org93446d5}
...
\label{sec:org830c048}

\subsection{On Complex Numbers}
\label{sec:org22b5a82}
...
\label{sec:orga47bcff}

\subsection{Architecture}
\label{sec:org39ed46c}
...
\label{sec:org8b964ce}

\subsection{Functional Programming}
\label{sec:org40593f7}
