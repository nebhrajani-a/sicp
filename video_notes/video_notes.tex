...
\chapter{Prologue}
\label{sec:org9f65bbc}
\section{About}
\label{sec:org243961b}
...
\label{sec:orgacc22f1}

\section{Substitution Rule/Model}
\label{sec:org4a18a71}
...
\label{sec:org8d8b378}

\subsection{Simple Peano Addition}
\label{sec:org37e2d90}
...
\label{sec:org6c6d1cf}

\section{Abstracting Procedural Ideas}
\label{sec:orgdc785f4}
...
\label{sec:org4172591}

\begin{enumerate}
\item Frames
\label{sec:orgbfb2a67}
...
\label{sec:orgc8f00fc}

\subsection{Using Lisp Syntax}
\label{sec:orgfd77e57}
...
may need to match, according to the rule language (\ref{sec:org7f5bfdd}).
...
expression are atomic and the same, (the case \texttt{foo} in \ref{sec:org7f5bfdd}), in which we simply return the dictionary, since the
...
Note that this is what the desired behaviour is (\ref{sec:org155c13f}).
\end{itemize}

\subsection{Dictionary Implementation}
\label{sec:org7349fbf}
...
\label{sec:orgec8f3b3}

\subsection{On Complex Numbers}
\label{sec:orgf67aafc}
...
\label{sec:orgb190662}

\subsection{Architecture}
\label{sec:org1d98f83}
...
\label{sec:org7a09d34}

\subsection{Functional Programming}
\label{sec:org7cae5ac}
