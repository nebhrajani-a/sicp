...
\label{sec:orgdec6d9b}

\section{Substitution Rule/Model}
\label{sec:org181ee3b}
...
\label{sec:orgb880736}

\subsection{Simple Peano Addition}
\label{sec:org36bf8e4}
...
\label{sec:org7e9522b}

\section{Abstracting Procedural Ideas}
\label{sec:org28eff89}
...
\label{sec:orgadd2b45}

\subsection{Using Lisp Syntax}
\label{sec:orgef695e6}
