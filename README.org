* Structure and Interpretation of Computer Programs Notes
  ...
  Wizard Book, is a book based on introductory computer science course
  taught at MIT from 1981 to 2007. It teaches the Scheme dialect of
  Lisp, and is worth reading if you're a serious programmer of any
  sort, if only because it teaches Lisp.
  Eric Raymond on Lisp:
